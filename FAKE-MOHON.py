# Decompile by Mardis (Tools By MohOn-Ahmed)
...
def notice():
	...
	runtxt("\033[0;92m ADMIN FACEBOOK >> MOHON AHMED ")
	subprocess.check_output(["am", "start", "https://www.facebook.com/rm.mohon.01"])
...
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            MOHON AHMED 
     \033[1;91m➣ \033[1;92mFACEBOOK   :            ─ Uʆʆ MoʜOŋ 🩷🪽
     \033[1;93m➣ \033[1;92mWHATSAPP   :            01314848631 
     \033[1;96m➣ \033[1;92mGITHUB     :            sorry😔🌸
...
#				exit()
	...
	def email(self):
		x = 111
		xx = 999
		nam = input("%s [?] TYPE A NAME %s(EX:MOHON ): "%(Y,G))
		nam = nam.replace(" ", "")
